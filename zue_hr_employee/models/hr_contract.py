...
class hr_contract_concepts(models.Model):
    ...
    z_employee_id = fields.Many2one(related='contract_id.employee_id', store=True, string="Empleado")
    z_branch_id = fields.Many2one(related='contract_id.employee_id.branch_id', store=True, string="Sucursal")
    z_company_id = fields.Many2one(related='contract_id.employee_id.company_id', store=True, string='Compañía')
