...
class account_move_line(models.Model):
    ...
    required_partner = fields.Boolean(related='account_id.required_partner', string="Obliga tercero", help='Muestra si la cuenta contable exige identificar un tercero.')
