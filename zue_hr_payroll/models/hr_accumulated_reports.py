    ...
    def generate_excel(self):
        ...
        query_report = '''
            Select a."number" as liquidacion,a."name" as descripcion,
                    ...
                    g."name" as categoria_regla, f."name" as regla_salarial,coalesce(m."name",'') as entidad,
            ...
            %s          
            order by a.date_from,a.date_to,b."name",h."name", c."name", f."sequence"            
        ''' % (query_where)
        ...
        #Columnas
        columns = ['Liquidación', 'Descripción', 'Fecha liquidación', 'Fecha inicial', 'Fecha final', 'Compañía',
        ...
        text_title = 'Acumulados'
        text_dates = 'Rango de Fechas: %s a %s' % (date_from, date_to)
        ...
        sheet.merge_range('A2:H2', text_dates, cell_format_title)
        # Agregar columnas
        aument_columns = 0
