                ...
                for slip in self.web_progress_iter(slip_mapped_data[journal_id][slip_date], msg="Contabilizar",
                    ...
                    if len(slip.line_ids) > 0:
                        ...
                        for line in slip.line_ids.filtered(lambda line: line.category_id):
                            ...
                            if (debit_account_id and amount >= 0 and line.code != 'NET') or (debit_account_id and line.code == 'NET' and amount < 0):  # If the rule has a debit account.
                            ...
                            if (credit_account_id and amount < 0 and line.code != 'NET') or (credit_account_id and line.code == 'NET' and debit == 0.0):  # If the rule has a credit account.
